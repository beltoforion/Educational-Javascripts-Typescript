var GameOfLife = (function () {
    function GameOfLife(cfg, pat) {
        // Colors and Styles
        this.rgbaDead = [30, 30, 35, 255];
        this.rgbaAlive = [255, 255, 105, 255];
        this.colGrid = "#202040";
        this.colGrid2 = "#252540";
        // Settings
    ...
    GameOfLife.prototype.mouseDown = function (evt) {
    ...
    GameOfLife.prototype.getMousePos = function (canvas, evt) {
    ...
    GameOfLife.prototype.setCellValue = function (x, y, v) {
    ...
    GameOfLife.prototype.getCellValue = function (i, x, y) {
        if (!this.is_toroidal) {
    ...
    GameOfLife.prototype.initPresets = function () {
        var p = new Array();
        var i = 0;
        // R-pentomino
    ...
    GameOfLife.prototype.randomCells = function () {
    ...
    GameOfLife.prototype.initWithPattern = function (p) {
        this.clearCells();
    ...
    GameOfLife.prototype.rleDecode = function (xpos, ypos, str) {
        var buf = "";
        var line = "";
        var col = xpos;
        var row = ypos;
    ...
    GameOfLife.prototype.move = function () {
        // copy world data
        this.world_data[1].set(this.world_data[0]);
        var ct = 0;
        var v;
    ...
    GameOfLife.prototype.tick = function () {
        switch (GameOfLife.CMD) {
            case "pat1":
                this.initWithPattern(this.presets[0]);
                break;
            case "pat2":
                this.initWithPattern(this.presets[1]);
                break;
            case "pat3":
                this.initWithPattern(this.presets[2]);
                break;
            case "pat4":
                this.initWithPattern(this.presets[3]);
                break;
            case "pat5":
                this.initWithPattern(this.presets[4]);
                break;
            case "pat6":
                this.initWithPattern(this.presets[5]);
                break;
            case "pat7":
                this.initWithPattern(this.presets[6]);
                break;
            case "pat8":
                this.initWithPattern(this.presets[7]);
                break;
            case "pat9":
                this.initWithPattern(this.presets[8]);
                break;
            case "pat10":
                this.initWithPattern(this.presets[9]);
                break;
            case "pat11":
                this.initWithPattern(this.presets[10]);
                break;
            case "pat12":
                this.initWithPattern(this.presets[11]);
                break;
            case 'single':
